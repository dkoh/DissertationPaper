...
\jmlrheading{1}{2012}{1-48}{4/00}{10/00}{Derek Koh and George Runger}

% Short headings should be running head and authors last names
\ShortHeadings{Generalized Asymmetric SVM and its Application}{Koh and Runger}
\firstpageno{1}
...
\begin{algorithm}
\For{$r=1 \text{ to } 10$}{
	Assign the data randomly into $K$ folds where $k=1,2,...,K$\\
	\For{Each of the $K$ folds}{
		set $\text{fold}_k$ as outsample and the rest of the data as insample\\
		Train learner $f(\cdot)$ on the insample\\
		Find $\hat{y}=f(\mathbf{x}) \text{   }\forall \mathbf{x} \in \text{fold}_k$
	}
	Calculate $\text{TP}_r,\text{FP}_r,\text{TN}_r,\text{FN}_r,\text{Precision}_r, \text{Recall}_r$ 
}
...
\begin{figure}[htp]
  \begin{center}
    \subfigure[Standard SVM]{\label{Fig:standardsvm}\includegraphics[scale=0.3]{img/asymSVMimages/RegularSVM}}
    \subfigure[Quantile SVM $\rho_1$=0.5]{\label{Fig:quantilesvm50}\includegraphics[scale=0.3]{img/asymSVMimages/MedianSVM}} \\
    \subfigure[Quantile SVM $\rho_1$=0.4]{\label{Fig:quantilesvm40}\includegraphics[scale=0.3]{img/asymSVMimages/p1_40_svm}}
    \subfigure[Quantile SVM $\rho_1$=0.6]{\label{Fig:quantilesvm60}\includegraphics[scale=0.3]{img/asymSVMimages/p1_60_svm}} \\
    \subfigure[Quantile SVM $\epsilon_1$=1]{\label{Fig:quantilesvmP3}\includegraphics[scale=0.3]{img/asymSVMimages/p3_1_svm}}
    \subfigure[Quantile SVM $\epsilon_2$=1]{\label{Fig:quantilesvmP4}\includegraphics[scale=0.3]{img/asymSVMimages/p4_1_svm}}
  \end{center}
...
% Table generated by Excel2LaTeX from sheet 'Finalresults1'
\begin{table}[htp]
  \centering
    \tiny\begin{tabular}{rrrrr|rrrrrrrr}
    \hline
